...
export default function InventoryManagement({ onItemClick }: InventoryManagementProps) {
  ...
  const filteredItems = items.filter(item => {
    ...
    const matchesLocation = filters.location.length === 0 || filters.location.includes(item.location.lab);
    ...
    return matchesCategory && matchesLocation && matchesStatus && matchesManufacturer && matchesSearch;
  });
